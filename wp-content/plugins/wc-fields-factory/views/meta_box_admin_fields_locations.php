				...
				<td>
					...
					<?php if ($rule) { ?>
						...
						<div class="wcff_location_logic_group"> 
							<h4><?php echo __( 'Place this fields on', 'wc-fields-factory' ); ?></h4>
							...
							<div id="wccaf_custom_product_data_tab_title_container" style="display: <?php echo (!is_array($rule["endpoint"]) && $rule["endpoint"] == "wccaf_custom_product_data_tab") ? "block" : "none"; ?>;">
								...
								<input type="text" name="wcff_custom_product_data_tab_title" id="wccaf_custom_product_data_tab_title" placeholder="Title" value="<?php echo wcff()->dao->load_custom_product_data_tab_title($post->ID); ?>" />
								<input type="number" name="wcff_custom_product_data_tab_priority" id="wccaf_custom_product_data_tab_priority" placeholder="Priority" value="<?php echo wcff()->dao->load_custom_product_data_tab_priority($post->ID); ?>" />
							</div>
