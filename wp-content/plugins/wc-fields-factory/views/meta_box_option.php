	...
	<div class="wrap wcff-options-wrapper">		
		...
		<form action='options.php' method='post' class='wcff-options-form'>		
			...
			<?php if (isset($wcff_options["version"])) : ?>
				...
				<input type="hidden" name="wcff_options[version]" value="<?php echo $wcff_options["version"]; ?>"/>
			<?php endif; ?>
			...
			<table class="wcff-option-field-row wcff_table">			
				...
				<tr>
					<td class="summary">
						<label><?php _e( 'Enable / Disable Modules', 'wc-fields-factory' ); ?></label>
						<p class="description"><?php _e( 'Option to disable unwanted feature for your instance.!', 'wc-fields-factory' ); ?></p>
					</td>
					<td>
						<div class="wcff-field-types-meta">							
							<div class="wcff-options-module-status">								
								...
								<ul class="wcff-field-layout-horizontal">
									...
									<li><label><input type="radio" name="wcff_options[enable_variable_field]" value="yes" <?php echo ($variable_module == "yes") ? "checked" : ""; ?>/> <?php _e( 'Enable', 'wc-fields-factory' ); ?></label></li>
									<li><label><input type="radio" name="wcff_options[enable_variable_field]" value="no" <?php echo ($variable_module == "no") ? "checked" : ""; ?>/> <?php _e( 'Disable', 'wc-fields-factory' ); ?></label></li>
								</ul>

								<ul class="wcff-field-layout-horizontal">
									<li><h3>Admin Fields </h3></li>
									<li><label><input type="radio" name="wcff_options[enable_admin_field]" value="yes" <?php echo ($admin_module == "yes") ? "checked" : ""; ?>/> <?php _e( 'Enable', 'wc-fields-factory' ); ?></label></li>
									<li><label><input type="radio" name="wcff_options[enable_admin_field]" value="no" <?php echo ($admin_module == "no") ? "checked" : ""; ?>/> <?php _e( 'Disable', 'wc-fields-factory' ); ?></label></li>
								</ul>

								<ul class="wcff-field-layout-horizontal">
									<li><h3>Checkout Fields </h3></li>
									<li><label><input type="radio" name="wcff_options[enable_checkout_field]" value="yes" <?php echo ($checkout_module == "yes") ? "checked" : ""; ?>/> <?php _e( 'Enable', 'wc-fields-factory' ); ?></label></li>
									<li><label><input type="radio" name="wcff_options[enable_checkout_field]" value="no" <?php echo ($checkout_module == "no") ? "checked" : ""; ?>/> <?php _e( 'Disable', 'wc-fields-factory' ); ?></label></li>
								</ul>
				...
				<tr>
					<td class="summary">
						...
						<p class="description"><?php _e( 'Display custom fields data on Cart & Checkout page.!', 'wc-fields-factory' ); ?></p>
					</td>
					<td>
						<div class="wcff-field-types-meta">
							<ul class="wcff-field-layout-horizontal">
					...
					<td>
						<div class="wcff-field-types-meta">
							<ul class="wcff-field-layout-horizontal wcff-field-location-on-product">
								<li><label><input type="radio" class="wcff-fields-product-location-radio" name="wcff_options[field_location]" value="woocommerce_before_add_to_cart_button" <?php echo ($fields_location == "woocommerce_before_add_to_cart_button") ? "checked" : ""; ?>/> <?php _e( 'Before Add To Cart Button', 'wc-fields-factory' ); ?></label></li>
								<li><label><input type="radio" class="wcff-fields-product-location-radio" name="wcff_options[field_location]" value="woocommerce_after_add_to_cart_button" <?php echo ($fields_location == "woocommerce_after_add_to_cart_button") ? "checked" : ""; ?>/> <?php _e( 'After Add To Cart Button', 'wc-fields-factory' ); ?></label></li>
								<li><label><input type="radio" class="wcff-fields-product-location-radio" name="wcff_options[field_location]" value="woocommerce_before_add_to_cart_form" <?php echo ($fields_location == "woocommerce_before_add_to_cart_form") ? "checked" : ""; ?>/> <?php _e( 'Before Add To Cart Form', 'wc-fields-factory' ); ?></label></li>
								<li><label><input type="radio" class="wcff-fields-product-location-radio" name="wcff_options[field_location]" value="woocommerce_after_add_to_cart_form" <?php echo ($fields_location == "woocommerce_after_add_to_cart_form") ? "checked" : ""; ?>/> <?php _e( 'After Add To Cart Form', 'wc-fields-factory' ); ?></label></li>
								<li><label><input type="radio" class="wcff-fields-product-location-radio" name="wcff_options[field_location]" value="woocommerce_before_single_product_summary" <?php echo ($fields_location == "woocommerce_before_single_product_summary") ? "checked" : ""; ?>/> <?php _e( 'Before Product Summary', 'wc-fields-factory' ); ?></label></li>
								<li><label><input type="radio" class="wcff-fields-product-location-radio" name="wcff_options[field_location]" value="woocommerce_after_single_product_summary" <?php echo ($fields_location == "woocommerce_after_single_product_summary") ? "checked" : ""; ?>/> <?php _e( 'After Product Summary', 'wc-fields-factory' ); ?></label></li>
								<li><label><input type="radio" class="wcff-fields-product-location-radio" name="wcff_options[field_location]" value="woocommerce_single_product_summary" <?php echo ($fields_location == "woocommerce_single_product_summary") ? "checked" : ""; ?>/> <?php _e( 'Product Summary', 'wc-fields-factory' ); ?></label></li>
								<li><label><input type="radio" class="wcff-fields-product-location-radio" name="wcff_options[field_location]" value="woocommerce_single_product_tab" <?php echo ($fields_location == "woocommerce_single_product_tab") ? "checked" : ""; ?>/> <?php _e( 'Product Tab', 'wc-fields-factory' ); ?></label></li>
								<li><label><input type="radio" class="wcff-fields-product-location-radio" name="wcff_options[field_location]" value="woocommerce_product_meta_start" <?php echo ($fields_location == "woocommerce_product_meta_start") ? "checked" : ""; ?>/> <?php _e( 'Before Product Meta', 'wc-fields-factory' ); ?></label></li>
								<li><label><input type="radio" class="wcff-fields-product-location-radio" name="wcff_options[field_location]" value="woocommerce_product_meta_end" <?php echo ($fields_location == "woocommerce_product_meta_end") ? "checked" : ""; ?>/> <?php _e( 'After Product Meta', 'wc-fields-factory' ); ?></label></li>
								<li><label><input type="radio" class="wcff-fields-product-location-radio" name="wcff_options[field_location]" value="woocommerce_product_custom_location" <?php echo ($fields_location == "woocommerce_product_custom_location") ? "checked" : ""; ?>/> <?php _e( 'Custom Location', 'wc-fields-factory' ); ?></label></li>								
							</ul>						
				...
				<tr>
					<td class="summary">
						<label for="post_type"><?php _e( 'Product Location Priority', 'wc-fields-factory' ); ?></label>
						<p class="description"><?php _e( 'Set custom priority for product location action', 'wc-fields-factory' ); ?></p>
					</td>
					<td>
						<div class="wcff-field-types-meta">
					...
					<td>
						<div class="wcff-field-types-meta">
							<ul class="wcff-field-layout-horizontal wcff-field-location-on-archive">
								<li><label><input type="radio" class="wcff-fields-archive-location-radio" name="wcff_options[field_archive_location]" value="woocommerce_before_shop_loop_item" <?php echo ($fields_archive_location == "woocommerce_before_shop_loop_item") ? "checked" : ""; ?>/> <?php _e( 'Before Shop Loop Item', 'wc-fields-factory' ); ?></label></li>
								<li><label><input type="radio" class="wcff-fields-archive-location-radio" name="wcff_options[field_archive_location]" value="woocommerce_before_shop_loop_item_title" <?php echo ($fields_archive_location == "woocommerce_before_shop_loop_item_title") ? "checked" : ""; ?>/> <?php _e( 'Before Shop Loop Item Title', 'wc-fields-factory' ); ?></label></li>
								<li><label><input type="radio" class="wcff-fields-archive-location-radio" name="wcff_options[field_archive_location]" value="woocommerce_shop_loop_item_title" <?php echo ($fields_archive_location == "woocommerce_shop_loop_item_title") ? "checked" : ""; ?>/> <?php _e( 'Shop Loop Item Title', 'wc-fields-factory' ); ?></label></li>
								<li><label><input type="radio" class="wcff-fields-archive-location-radio" name="wcff_options[field_archive_location]" value="woocommerce_after_shop_loop_item_title" <?php echo ($fields_archive_location == "woocommerce_after_shop_loop_item_title") ? "checked" : ""; ?>/> <?php _e( 'After Shop Loop Item Title', 'wc-fields-factory' ); ?></label></li>
								<li><label><input type="radio" class="wcff-fields-archive-location-radio" name="wcff_options[field_archive_location]" value="woocommerce_after_shop_loop_item" <?php echo ($fields_archive_location == "woocommerce_after_shop_loop_item") ? "checked" : ""; ?>/> <?php _e( 'Affter Shop Loop Item', 'wc-fields-factory' ); ?></label></li>						
								<li><label><input type="radio" class="wcff-fields-archive-location-radio" name="wcff_options[field_archive_location]" value="woocommerce_archive_custom_location" <?php echo ($fields_archive_location == "woocommerce_archive_custom_location") ? "checked" : ""; ?>/> <?php _e( 'Custom Location', 'wc-fields-factory' ); ?></label></li>						
							</ul>	
				...
				<tr>
					<td class="summary">
						...
						<p class="description"><?php _e( 'Display custom fields per product count. Whenever user increases the product quantity, all custom fields will be cloned.!', 'wc-fields-factory' ); ?></p>
					</td>
					<td>
						<div class="wcff-field-types-meta">
							<ul class="wcff-field-layout-horizontal">
				...
				<tr>
					<td class="summary">
						<label><?php _e( 'Authorized Users Only', 'wc-fields-factory' ); ?></label>
						<p class="description"><?php _e( 'Show fields only if user has logged-in', 'wc-fields-factory' ); ?></p>
					</td>
					<td>
						<div class="wcff-field-types-meta">							
							<ul class="wcff-field-layout-horizontal">
				...
				<tr>
					<td class="summary">
						<label><?php _e( 'Enable Cart Editable', 'wc-fields-factory' ); ?></label>
				...
				<tr>
					<td class="summary">
						<label><?php _e( 'Enable Custom Pricing', 'wc-fields-factory' ); ?></label>
						<p class="description"><?php _e( 'Enable custom pricing module', 'wc-fields-factory' ); ?></p>
					</td>
					<td>
						<div class="wcff-field-types-meta">							
							<ul class="wcff-field-layout-horizontal">
								<li><label><input type="radio" name="wcff_options[enable_custom_pricing]" value="yes" <?php echo ($custom_pricing_module == "yes") ? "checked" : ""; ?>/> <?php _e( 'Yes', 'wc-fields-factory' ); ?></label></li>
								<li><label><input type="radio" name="wcff_options[enable_custom_pricing]" value="no" <?php echo ($custom_pricing_module == "no") ? "checked" : ""; ?>/> <?php _e( 'No', 'wc-fields-factory' ); ?></label></li>
							</ul>						
						</div>
					</td>
				</tr>	
				...
				<tr>
					<td class="summary">
						<label><?php _e( 'Pricing Rules Behaviour', 'wc-fields-factory' ); ?></label>
						...
						<div class="wcff-field-types-meta">			
								<div class="wcff-factory-tab-container">
									<div class="wcff-factory-tab-left-panel">
										<ul>
											<li data-box="#wcff-real-time-pricing" class="selected"><label><?php _e( 'Update Price.?', 'wc-fields-factory' ); ?></label></li>											
											<li data-box="#wcff-pricing-title-shows"><label><?php _e( 'Price Rule Title', 'wc-fields-factory' ); ?></label></li>
											<li data-box="#wcff-wc-price-tag-selector"><label><?php _e( 'Price Tag Selector', 'wc-fields-factory' ); ?></label></li>
										</ul>
									</div>
									<div class="wcff-factory-tab-right-panel wcff-panel-tab-right-container">
										...
										<div id="wcff-pricing-title-shows" class="wcff-factory-tab-content">
											<div class="">												
												...
												<p class="description"><?php _e( 'Pricing rule details, want to show in product, cart & checkout page.', 'wc-fields-factory' ); ?></p>
											</div>											
										</div>
				...
				<tr>
					<td class="summary">
						<label><?php _e( 'Enable Multilingual', 'wc-fields-factory' ); ?></label>
					...
					<td>
						...
						<div id="wcff-multilingual-locale-list" style="<?php echo ($enable_multilingual == "yes") ? "display: block;" : "display: none;"; ?>">
							...
							<label><?php _e( 'Choose default language', 'wc-fields-factory' ); ?></label>
