...
class wcff_cart_editor {
	...
	private function render_data($_field, $_val, $_index = "") {
		...
		if ($_field ["type"] != "file" && $_field ["type"] != "checkbox" && $_field ["type"] != "colorpicker") {
			$meta_html .= '<li class="' . $editable_class . '" ' . $tooltip . ' data-field="' . $_field ["key"] . '" data-fieldkey="' . ($_field ["key"] . $_index) . '" data-productid="' . esc_attr ( $this->cart_item ["product_id"] ) . '" data-itemkey="' . esc_attr ( $this->cart_item_key ) . '">' . wp_kses_post ( wpautop ( stripslashes ( $_val ) ) ) . '</li>';
		} else if ($_field ["type"] == "checkbox") {
			$meta_html .= '<li class="' . $editable_class . '" ' . $tooltip . ' data-field="' . $_field ["key"] . '" data-fieldkey="' . ($_field ["key"] . $_index) . '" data-productid="' . esc_attr ( $this->cart_item ["product_id"] ) . '" data-itemkey="' . esc_attr ( $this->cart_item_key ) . '">' . wp_kses_post ( wpautop ( (is_array ( $_val ) ? implode ( ",", $_val ) : stripslashes ( $_val )) ) ) . '</li>';
			...
			$meta_html .= '<li class="' . $editable_class . '" ' . $tooltip . ' data-field="' . $_field ["key"] . '" data-fieldkey="' . ($_field ["key"] . $_index) . '" data-productid="' . esc_attr ( $this->cart_item ["product_id"] ) . '" data-itemkey="' . esc_attr ( $this->cart_item_key ) .'" '. $show_as_color .'>' . $color_val . '</li>';
		} else {
			...
			if ($is_multi_file == "yes") {
				...
				$meta_html .= '<li class="wcff_field_cart_updater_clone" data-field="' . $_field ["key"] . '" data-fieldkey="' . ($_field ["key"] . $_index) . '" data-productid="' . esc_attr ( $this->cart_item ["product_id"] ) . '" data-itemkey="' . esc_attr ( $this->cart_item_key ) . '">' . wp_kses_post ( implode ( ", ", $fkeys ) ) . '</li>';
			} else {
				$fobj = json_decode ( $_val, true );
				$path_parts = pathinfo ( $fobj ['file'] );
				if ($_field ["img_is_prev"] == "yes" && @getimagesize ( $fobj ["url"] )) {
					$meta_html .= '<li data-field="' . $_field ["key"] . '" data-fieldkey="' . ($_field ["key"] . $_index) . '" data-productid="' . esc_attr ( $this->cart_item ["product_id"] ) . '" data-itemkey="' . esc_attr ( $this->cart_item_key ) . '"><img src="' . $fobj ["url"] . '" style="width:' . $_field ["img_is_prev_width"] . 'px;"></li>';
				} else {
					$meta_html .= '<li class="wcff_field_cart_updater_clone" data-field="' . $_field ["key"] . '" data-fieldkey="' . ($_field ["key"] . $_index) . '" data-productid="' . esc_attr ( $this->cart_item ["product_id"] ) . '" data-itemkey="' . esc_attr ( $this->cart_item_key ) . '">' . wp_kses_post ( stripslashes ( $path_parts ["basename"] ) ) . '</li>';
				}
			}
		}
		$meta_html .= '</ul>';
